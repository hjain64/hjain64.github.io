    ...
    <div>
      <div className="shadow-lg p-2 rounded-xl my-10">
        ...
        <p className="text-xs py-4 text-slate-700">
          ...
          skills to new heights as I strive to solve as many puzzles as
          possible. This consistent effort reflects a commitment to continuous
          learning and a passion for unraveling complex coding scenarios
        </p>
