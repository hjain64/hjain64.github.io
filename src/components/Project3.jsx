    ...
    <div>
      <div className="shadow-lg p-2 rounded-xl my-10">
        ...
        <p className="text-xs py-4 text-slate-700">
          ...
          aimed at learning mobile game development. The app runs on both
          Android and iOS, providing an engaging experience. Defend your garden
          from zombie attacks, strategically using stars to spawn defenders.
          With three progressively challenging levels, the game offers an
